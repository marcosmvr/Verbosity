...
export async function runEnglishQuiz() {
    ...
    try {
        ...
        if (questions.length === 0) {
            console.log('Não foi possível gerar nenhuma pergunta. Tente novamente mais tarde.');
            return;
        }
        let score = 0;
        ...
        console.error('Ocorreu um erro inesperado ao iniciar o quiz:', error.message || error);
    }
}
runEnglishQuiz();
